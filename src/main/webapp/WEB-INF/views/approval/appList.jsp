...
<body>
	...
	<input type = "button" name = "excelDown" id = "excelDown" value = "엑셀다운 " onclick = "location.href = '/boardListExcel'">
	<input type = "button" name = "excelUpload" id = "excelUpload" value = "엑셀업로드" onclick = "location.href = '/excelUpload'">
	<br>
